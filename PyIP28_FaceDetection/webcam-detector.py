# Wtire a program to open webcam and apply some filters on your face:
# Press 1️⃣: checkered_face
# Press 2️⃣: lips_eys
# Press 3️⃣: sticker_on_face
# Press 4️⃣: mirror_filter
...
def lips_detection(image):
    ...
    sticker=cv2.imread("input\lip.jpg")
...
def sticker_on_face(image):
    ...
    sticker=cv2.imread("input\smile-sticker.png")
