...
# cv2.imwrite("output/lip.jpg", fit_lip)
# cv2.imwrite("output/right_eye.jpg", fit_right_eye)
# cv2.imwrite("output/left_eye.jpg", fit_left_eye)

red_apple=cv2.imread("input/apple.jpg")
...
cv2.imwrite("output/apple_filter.jpg", red_apple)