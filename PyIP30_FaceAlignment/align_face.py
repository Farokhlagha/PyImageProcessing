# Align Face hint: https://github.com/Alireza-Akhavan/deep-face-recognition/blob/master/7_face-align-with-eyes.ipynb
# !pip install mtcnn
...
img = plt.imread("input/MrBin.jpg")
...
draw_facebox_and_keypoints('input/MrBin.jpg', results)
